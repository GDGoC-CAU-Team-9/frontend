...
class _AnalysisResultScreenState extends ConsumerState<AnalysisResultScreen> {
  ...
  Widget _buildBestSummaryCard(MenuAnalysisResult best) {
    return Container(
                ...
                if (results.isEmpty)
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Row(
                        children: [
                          ...
                          Text(
                            DateFormat('yyyy.MM.dd HH:mm').format(_analyzedAt),
                            style: const TextStyle(
                              color: Color(0xFF617D7A),
                              fontWeight: FontWeight.w600,
                              fontSize: 13,
                  ...
                  if (best != null)
                    SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                        child: _buildBestSummaryCard(best),
                      ),
                    ),
                  SliverPadding(
